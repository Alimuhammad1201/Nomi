...
<head>
  ...
  <title>Luxrio - The Fashion & Watch E-Commerce HTML5 Template | Vecuro | Dashboard 2 </title>
...
<body class="vs-body2">
  ...
  <div class="vs-menu-wrapper">
    <div class="vs-menu-area text-center">
      <div class="mobile-logo">
        <a href="index.html"><img src="{{ asset('assets/img/logo.png ') }}" alt="Carmax" class="logo"></a>
  ...
  <div class="sidemenu-wrapper">
    <div class="sidemenu-content">
      <div class="sidemenu-logo">
        <a href="index.html"><img src="{{ asset('assets/img/logo.svg ') }}" alt="Greeno" class="logo"></a>
  ...
  <main class="main">
    <!--==============================
        Header Area
    ==============================-->
    <header class="vs-header layout3">
      <!-- Main Menu Area -->
          ...
          <div class="container custom-container">
            <div class="row justify-content-between align-items-center">
              ...
              <div class="col-xl-4 col-lg-auto">
                <div class="header-logo style3 text-center">
                  <a href="index-2.html"><img src="{{ asset('assets/img/logo.svg ') }}" alt="Luxrio" class="logo"></a>
                </div>
              </div>
              <div class="col-xl-4 col-lg-auto">
                <div class="d-flex justify-content-between justify-content-lg-end align-items-center gap-3">
                  <nav class="main-menu menu-style1 d-none d-lg-block text-end">
                    <ul>
                      <li class="menu-item-has-children mega-menu-wrap">
                        <a href="javascript:void(0)">Pages</a>
                        <ul class="mega-menu">
                  ...
                  <div class="d-lg-none">
                    <button class="vs-menu-toggle d-inline-flex align-items-center"><i
      ...
      <img class="svg-line d-none d-xxl-block" src="{{ asset('assets/img/shapes/nsp-line.svg ') }}" alt="">
    </header>
    <!--==============================
      Hero Area
  ==============================-->
