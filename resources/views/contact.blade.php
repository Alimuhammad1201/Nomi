      ...
      <div class="container">
        <div class="row gx-60 align-items-center">
          <div class="col-lg-5 mb-30">
            ...
            <img src="assets/img/icons/vs-ct-icon-1-1.svg" alt="vs icon">
            Customer Service :
            <a href="tel:+9-555-888-679">+9-555-888-679</a>
          </span>
              <span class="address-info">
            <img src="assets/img/icons/vs-ct-icon-1-2.svg" alt="vs icon">
            Careers :
          ...
          <div class="col-lg-7 mb-30">
            <form action="mail.php" method="post" class="form-style2 ajax-contact" action="mail.php" method="POST">
              <div class="row gx-20">
