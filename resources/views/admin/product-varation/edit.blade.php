                    ...
                    <div class="sparkline10-graph">
                        ...
                        <div id="pwd-container3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control example3" id="Regulier Price" name="Regulier Price" placeholder="Regulier Price"  >
                            </div>

                            <div class="form-group">
                                <label style="color: white" for="Sele Price">Product Sele Price</label>
                                <input type="text" class="form-control example3" id="Sele Price" name="Sele Price" placeholder="Sele Price"  >
                            </div>

                            <div class="form-group">
                                <label style="color: white" for="quantity">Product quantity</label>
                                <input type="text" class="form-control example3" id="quantity" name="quantity" placeholder="quantity"  >
                            </div>
