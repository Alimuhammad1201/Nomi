...
@enderror
        ...
        <div class="social">
          <a href="{{ route('register')}}"><div class="go"><i class="fab fa-google"></i>Register</div></a>
          <a href="{{ route('password.request') }}"><div class="fb"><i class="fab fa-facebook"></i>  Reset Pass</div></a>
        </div>
    </form>
